...
<div class="col-lg-10">
<h1 class="text-warning text-center" > Les notifications </h1>
...
while($row = $query->fetch()){
   echo '<form action="deleteNotification.php" method="POST">';
   echo "<tr class=text-center>";
   echo '<td><input type="text" name="idn" value="'.$row['idn'].'" readonly style="width:35px;border: none;border-color: transparent;"></td>';
...
<div class="float-right"><form action="addNotification.php"><button type="submit" class="btn btn-outline-warning">Add notification</button></form></div>
